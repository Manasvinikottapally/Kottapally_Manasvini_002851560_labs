...
public class SupplierWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblWelcome.setFont(new java.awt.Font("Helvetica Neue", 0, 15)); // NOI18N
    ...
    private void btnManageProductCatalogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProductCatalogActionPerformed
        // TODO add your handling code here:
        ManageProductCatalogJPanel mpcjp = new ManageProductCatalogJPanel(menuBar, supplier);
        menuBar.add("ManageProductCatalogJPanel", mpcjp);
        CardLayout layout = (CardLayout) menuBar.getLayout();
        layout.next(menuBar);
