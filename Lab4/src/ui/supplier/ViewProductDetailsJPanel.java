...
public class ViewProductDetailsJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewProductDetailsJPanel(JPanel workArea, Product product) {
        initComponents();
    ...
    private void saveFeatures() {
       ...
       for(int i =0 ; i <model.getRowCount(); i++){
           Features currentFeature = product.getFeatures().get(i);
    ...
    private void btnAddFeatureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddFeatureActionPerformed
        // TODO add your handling code here:
        Features newFeature = product.addNewFeature();
